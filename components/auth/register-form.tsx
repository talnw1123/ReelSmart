...
export default function RegisterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // จำลองการเรียก API สำหรับการสมัครสมาชิก
    try {
      // ในสถานการณ์จริง คุณจะเรียก API ที่นี่
      await new Promise((resolve) => setTimeout(resolve, 1500))

      // เมื่อสมัครสมาชิกสำเร็จ นำทางกลับไปยังหน้าหลัก
      router.push("/")
    } catch (err) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-gray-400 mt-1">รหัสผ่านต้องมีอย่างน้อย 8 ตัวอักษร</p>
      </div>
      ...
      <div className="relative flex items-center justify-center">
        ...
        <span className="bg-gray-900 px-2 text-xs text-gray-400 relative">หรือสมัครด้วย</span>
      </div>
